...
function preload() {
  // 請再次確認圖片檔名是否為 _0.0.jpg 或 _0.jpg，我這裡使用 _0.jpg 作為預設
  quizImages[0] = loadImage('assets/S__5554180_0.jpg');
  quizImages[1] = loadImage('assets/S__5554185_0.jpg'); // 修正為 _0.jpg
  quizImages[2] = loadImage('assets/S__5554184_0.jpg'); // 修正為 _0.jpg
  quizImages[3] = loadImage('assets/S__5554181_0.jpg'); // 修正為 _0.jpg
  quizImages[4] = loadImage('assets/S__5554182_0.jpg'); // 修正為 _0.jpg
  quizImages[5] = loadImage('assets/S__5554183_0.jpg'); // 修正為 _0.jpg

  resultImages['大吉'] = loadImage('assets/S__5554191_0.jpg'); // 修正為 _0.jpg
  resultImages['吉'] = loadImage('assets/S__5554187_0.jpg'); // 修正為 _0.jpg
  resultImages['中吉'] = loadImage('assets/S__5554189_0.jpg'); // 修正為 _0.jpg
  resultImages['末吉'] = loadImage('assets/S__5554188_0.jpg'); // 修正為 _0.jpg
  resultImages['天選之人'] = loadImage('assets/S__5554190_0.jpg'); // 修正為 _0.jpg
}
...
function initCurtain() {
  ...
  // === 修正 1 & 2: 「陸禹垛」文字大小與位置 ===
  // 大幅增大文字大小，使其輪廓更清晰，並在視覺上佔據中心位置
  pg.textSize(width * 0.2); // 從 0.12 增大到 0.2，嘗試讓字體更大
  // Y 座標直接設為 height / 2，讓 P5.js 根據 CENTER 對齊來居中
  pg.text("陸  禹  垛", width / 2, height / 2); 
  ...
  for (let i = 0; i < cols; i++) {
    ...
    for (let j = 0; j < beadsPerChain; j++) {
      ...
      let px = pg.get(x, y);
      // 保持判斷閾值 100，因為字體已經足夠大，這個閾值應該足以捕捉輪廓
...
function drawCurtain() {
  for (let nodes of chains) {
    ...
    for (let n of nodes) {
      if (!n.isText) {
        // === 修正 3: 增大非文字珠子大小為原來的 1.5 倍 (6 * 1.5 = 9) ===
    ...
    for (let n of nodes) {
      if (n.isText) {
        // === 修正 3: 增大文字珠子大小為原來的 1.5 倍 (9.75 * 1.5 ≈ 14.6) ===
