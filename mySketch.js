...
// LOD 相關變數
const interactionRadius = 200; // 鼠標/觸摸點周圍的交互半徑
const activeConstraintsIterations = 4; // 交互區域的約束迭代次數
const passiveConstraintsIterations = 1; // 非交互區域的約束迭代次數
...
function initCurtain() {
  ...
  // 為了確保「陸」字完整性，加大描邊粗細
  pg.stroke(255); 
  pg.strokeWeight(5); // 增加描邊粗細以確保文字筆劃完整
...
function drawCurtain() {
  ...
  for (let nodes of chains) {
    ...
    // LOD 策略：根據鏈條是否有珠子在交互半徑內來決定約束迭代次數
